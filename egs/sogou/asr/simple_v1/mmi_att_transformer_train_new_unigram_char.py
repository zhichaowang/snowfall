...
from snowfall.common import describe, str2bool, str_or_none
...
from snowfall.models.transformer import Noam, Transformer, Initialize
...
def run(rank, world_size, args):
    ...
    exp_dir = Path('exp-' + model_type + '-noam-mmi-att-sogou500h-4gpu-dur300-K2Conformer-unigram-char')
