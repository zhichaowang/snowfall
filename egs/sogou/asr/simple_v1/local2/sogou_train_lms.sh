...
if [ $# -ne 3 ]; then
  echo "Usage: local2/sogou_train_lms.sh <text> <lexicon> <dest-dir>"
  echo "e.g.: local2/sogou_train_lms.sh data/local/train/text data/local/dict_nosp/lexicon.txt data/local/lm"
  exit 1;
fi
